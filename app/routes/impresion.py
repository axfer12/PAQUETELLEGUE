...
def invoice_pdf(guia_id):
    ...
    from app.modules import invoice_pdf as inv
    try:
        ruta = inv.generar_pdf_invoice(remitente, destinatario, productos, purpose,
...
def invoice_download(guia_id):
    ...
    ruta = inv.generar_pdf_invoice(remitente, destinatario, productos,
                                   g.get("shipment_purpose","personal") or "personal",
                                   numero_guia=g.get("numero_guia",""))
    with open(ruta,"rb") as f_:
        data = f_.read()
