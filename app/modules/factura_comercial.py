...
- Ventana GUI (solo desktop con tkinter disponible)
"""
...
# ─────────────────────────────────────────────────────────────────
class VentanaFacturaComercial:
    """
    Ventana modal para capturar los productos de la factura comercial.
    Solo funciona en entornos con tkinter (desktop).
    """
    ...
    def __init__(self, parent, remitente: dict, destinatario: dict,
                 ...
                 on_confirm=None):
        # Import lazy — solo disponible en desktop con GUI
